...
const TestimonialsSection = ({ language }) => {
  const testimonials = [
    ...
    },
    {
      ...
      text: {
        en: 'Had a minor accident near Paleokastritsa. Corfu Line helped me find the nearest clinic instantly. Great service!',
        gr: 'Είχα ένα μικρό ατύχημα κοντά στην Παλαιοκαστρίτσα. Το Corfu Line με βοήθησε να βρω την πλησιέστερη κλινική αμέσως. Εξαιρετική υπηρεσία!'
      },
      rating: 5,
      category: 'medical'
    }
